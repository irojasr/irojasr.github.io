  ...
  <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; margin-top: 15px; font-size: 0.95rem;">
    ...
    <tbody>
      ...
      <tr style="border-bottom: 1px solid #e2e8f0; background-color: #fafafa;">
        ...
        <td style="padding: 10px;">
          <a href="TalksPosters.html#makenna">Mathematicians or Moles? A First Study in the Mesmerizing Psychology of Derek Moran and Enrique Mercado</a><br>
      ...
      <tr style="border-bottom: 1px solid #e2e8f0; background-color: #fafafa;">
        ...
        <td style="padding: 10px;">
          <a href="TalksPosters.html#michaelmoy">A rubber band, a mug, and 3-sphere</a> <span style="font-size: 0.85rem; color: #64748b;">(10 mins)</span>
        </td>
      </tr>
